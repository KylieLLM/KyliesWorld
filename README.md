...
To avoid git clashes in the core directory, we recommend adding custom actions to a `custom_actions` directory and then adding them to the `venchaiConfig.yaml` file. See the `venchaiConfig.example.yaml` file for an example.

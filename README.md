...
<a href= <a href="https://ibb.co/5WsdYgt"><img src="https://i.ibb.co/WWBQD4q/yessirrr-pfppppp.jpg" alt="yessirrr-pfppppp" border="0"></a><br /><a target='_blank' href='https://poetandpoem.com/interpretation-of-the-listeners-by-walter-de-la-mare'>summary of the listeners by walter de la mare</a><br />
...
To avoid git clashes in the core directory, we recommend adding custom actions to a `custom_actions` directory and then adding them to the `KylieConfig.yaml` file. See the `KylieConfig.example.yaml` file for an example.
